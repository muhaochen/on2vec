...
transh_file = 'yago-transh.ckpt'
data_file = 'yago-data.bin'
test_data = '../../../onto2vec-dataset/Yago/yagoFactsFiltCDTTest.tsv'
result_file = '../../results/yago/prc/prc_transh_tail.txt'
result_file2 = '../../results/yago/prc/prc_transh_head.txt'
result_file3 = '../../results/yago/prc/prc_transh_rel.txt'
