...
from trainer_transh import Trainer


# In[4]:
model_path = 'yago-transh.ckpt'
...
m_train.train(epochs=500, save_every_epoch=50, lr=0.001, a1=0.0, a2=2., m1=1., m2=1., balance_alpha1=True, feed_pre=False)
