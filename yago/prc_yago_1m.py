...
result_file = '../../results/yago100/prc/prc_model_tail.txt'
result_file2 = '../../results/yago100/prc/prc_model_head.txt'
result_file3 = '../../results/yago100/prc/prc_model_rel.txt'
