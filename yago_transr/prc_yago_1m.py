...
transr_file = 'yago-transr-1m.ckpt'
data_file = 'yago-data-1m.bin'
test_data = '../../../onto2vec-dataset/Yago/yagoFactsFiltCD100Test.tsv'
result_file = '../../results/yago100/prc/prc_transr_tail.txt'
result_file2 = '../../results/yago100/prc/prc_transr_head.txt'
result_file3 = '../../results/yago100/prc/prc_transr_rel.txt'
