...
transe_file = 'yago-transe-1m.ckpt'
data_file = 'yago-data-1m.bin'
test_data = '../../../onto2vec-dataset/Yago/yagoFactsFiltCD100Test.tsv'
result_file = '../../results/yago100/prc/prc_transe_tail.txt'
result_file2 = '../../results/yago100/prc/prc_transe_head.txt'
result_file3 = '../../results/yago100/prc/prc_transe_rel.txt'
