...
transe_file = 'yago-transe.ckpt'
data_file = 'yago-data.bin'
test_data = '../../../onto2vec-dataset/Yago/yagoFactsFiltCDTTest.tsv'
result_file = '../../results/yago/prc/prc_transe_tail.txt'
result_file2 = '../../results/yago/prc/prc_transe_head.txt'
result_file3 = '../../results/yago/prc/prc_transe_rel.txt'
...
tester = Tester()
tester.build(save_path = transe_file, data_save_path = data_file)
