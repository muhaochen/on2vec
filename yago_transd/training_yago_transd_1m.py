...
from trainer_transd import Trainer


# In[4]:
model_path = 'yago-transd-1m.ckpt'
...
m_train.train(epochs=500, save_every_epoch=50, lr=0.001, a1=0.0, a2=.2, m1=.5, m2=.5, balance_alpha1=False, feed_pre=False)