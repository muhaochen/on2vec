...
import os
if not os.path.exists('../../results/yago100'):
    os.makedirs('../../results/yago100')
...
from tester_transd import Tester

model_file = 'yago-transd-1m.ckpt'
data_file = 'yago-data-1m.bin'
test_data = '../../../onto2vec-dataset/Yago/yagoFactsFiltCD100Test.tsv'
result_file = '../../results/yago100/test_yago_transd.txt'
result_file2 = '../../results/yago100/test_yago_rel_transd.txt'
...
def test(tester, index, score_head, score_tail, score_trsym, score_hier, rank_head, rank_tail, rank_trsym, rank_hier):
    while index.value < len(tester.test_triples):
        ...
        head_pool = tester.projection_pool(tester.vec_c, r, h_or_t='h')
        tail_pool = tester.projection_pool(tester.vec_c, r, h_or_t='t')
