...
transd_file = 'yago-transd.ckpt'
data_file = 'yago-data.bin'
test_data = '../../../onto2vec-dataset/Yago/yagoFactsFiltCDTTest.tsv'
result_file = '../../results/yago/prc/prc_transd_tail.txt'
result_file2 = '../../results/yago/prc/prc_transd_head.txt'
result_file3 = '../../results/yago/prc/prc_transd_rel.txt'
...
tester = Tester()
tester.build(save_path = transd_file, data_save_path = data_file, pre_pool=True)
